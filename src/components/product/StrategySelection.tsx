...
/**
 * Компонент для выбора стратегии ценообразования
 */
export default function StrategySelection({
  ...
  return (
    <Box>
      {/* Информация о товаре */}
      <Box p={4} mb={4} borderWidth="1px" borderColor={borderColor} borderRadius="md">
      ...
      {/* Параметры стратегии */}
      <Box mb={6} p={4} borderWidth="1px" borderColor={borderColor} borderRadius="md">
      ...
      <Box p={4} bg={headerBg} borderRadius="md" mb={6}>
